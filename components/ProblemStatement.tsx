...
const ProblemStatement: React.FC<ProblemStatementProps> = ({ role }) => {
  ...
  return (
    <section className="py-32 lg:py-48 bg-[#030205] relative z-20 flex items-center justify-center overflow-hidden">
       ...
       <div className="container mx-auto px-6 text-center relative z-10">
            <motion.div 
             ...
             >
                <motion.div variants={itemVariants} className="inline-flex items-center justify-center gap-4 mb-8 opacity-60">
                    <div className="h-px w-8 lg:w-16 bg-gradient-to-r from-transparent to-white/50"></div>
                    <span className="text-xs lg:text-sm font-mono uppercase tracking-[0.3em] text-white">The Current Reality</span>
                    <div className="h-px w-8 lg:w-16 bg-gradient-to-l from-transparent to-white/50"></div>
                </motion.div>

                <motion.h2 
                    variants={itemVariants}
                    className="font-display font-bold text-4xl md:text-6xl lg:text-7xl mb-8 leading-[1.1] tracking-tight text-white drop-shadow-2xl"
                >
                ...
                <motion.p 
                    variants={itemVariants}
                    className="text-gray-300 text-lg md:text-xl lg:text-2xl leading-relaxed font-light max-w-3xl mx-auto drop-shadow-lg"
                >
